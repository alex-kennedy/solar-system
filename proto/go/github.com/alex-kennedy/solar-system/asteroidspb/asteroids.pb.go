...
const (
	ObitType_ORBIT_TYPE_UNKNOWN        ObitType = 0
	ObitType_ORBIT_TYPE_Q_BOUNDED      ObitType = 1
	ObitType_ORBIT_TYPE_HUNGARIA       ObitType = 2
	ObitType_ORBIT_TYPE_HILDA          ObitType = 3
	ObitType_ORBIT_TYPE_JUPITER_TROJAN ObitType = 4
	ObitType_ORBIT_TYPE_NEO            ObitType = 5
	ObitType_ORBIT_TYPE_ASTEROID_BELT  ObitType = 6
)

// Enum value maps for ObitType.
var (
	ObitType_name = map[int32]string{
	...
	ObitType_value = map[string]int32{
...
func (x ObitType) Enum() *ObitType {
	p := new(ObitType)
	*p = x
	return p
}

func (x ObitType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ObitType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_asteroids_proto_enumTypes[0].Descriptor()
}

func (ObitType) Type() protoreflect.EnumType {
	return &file_proto_asteroids_proto_enumTypes[0]
}

func (x ObitType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ObitType.Descriptor instead.
func (ObitType) EnumDescriptor() ([]byte, []int) {
...
type AsteroidGroup struct {
	...
	OrbitType ObitType `protobuf:"varint,1,opt,name=orbit_type,json=orbitType,proto3,enum=ObitType" json:"orbit_type,omitempty"`
...
func (x *AsteroidGroup) GetOrbitType() ObitType {
	if x != nil {
		return x.OrbitType
	}
	return ObitType_ORBIT_TYPE_UNKNOWN
}
...
var file_proto_asteroids_proto_rawDesc = []byte{
	...
	,
}
...
var file_proto_asteroids_proto_depIdxs = []int32{
	...
	0, // 1: AsteroidGroup.orbit_type:type_name -> ObitType
